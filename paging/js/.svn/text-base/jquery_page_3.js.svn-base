    ...
    TwbsPagination.prototype = {
        ...
        init: function (options) {
            ...
            var _this_=this;
             try{
             	var _a=1;
            	 $(".go_page button").click(function(){
            	 	 if(!isNaN($(".go_page input").val())){ 
            	 	 	if($(".go_page input").val()<0)
            	 	           _a=1;
            	 	      } 
            	 	    if($(".go_page input").val()>_this_.options.totalPages){
            	 	    	_a=_this_.options.totalPages;
            	 	    }
            	 	  _this_.show(parseInt(_a, 10));
                });
                }catch(e){
